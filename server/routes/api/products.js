...
router.get('/:slug', async function(req, res, next) {
  ...
  const frontEndMap = {
    "dbKey" :        ["year",        "terrain", "style",  "deckMaterials",     "drive",        "range",                  "speed",  "weight",       "maxWeight",    "batteryPower",               "hillGrade",                "speedModes",       "batteryCapacity",          "batteryWattHours",        "batteryRemovable",   "chargeTime",            "width",                       "length",                   "wheelDiameter",  "manufacturerWarranty",   "tags"],
    "displayName" :  ["Year",        "Terrain", "Style",  "Deck Material",      "Motor",       "Range",                  "Speed",  "Weight",       "Max Load",      "Wattage",                   "Hill Grade",                "Speed Modes",      "Battery Capacity",         "Battery WattHours" ,     "Battery Removable",   "Charge Time",          "Width",                       "Length",                    "Wheel Diameter",  "Manufacturer Warranty",  "Features"],
    "semanticIcon" : ["calendar check outline",   "road",    "adjust", "diamond", "power off", "map marker alternate", "dashboard", "balance scale", "weight",  "lightning",    "external square alternate",             "numbered list",    "battery three quarters",   "battery three quarters",               "plug",               "time",                 "arrows alternate horizontal", "arrows alternate vertical", "dot circle",            "tty",                 "tags"]
  }
